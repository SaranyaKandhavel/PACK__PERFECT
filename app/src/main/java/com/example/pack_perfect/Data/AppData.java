package com.example.pack_perfect.Data;

import android.app.Application;
import android.content.Context;

import com.example.pack_perfect.Constants.MyConstants;
import com.example.pack_perfect.Database.RoomDB;
import com.example.pack_perfect.Models.Items;
...
public class AppData extends Application {
    ...
    public List<Items> getClothingData() {
        String []data = {"Stockings","Underwear","Pyjamas","T-Shirts","Casual Dress","Evening Dress",
    ...
    public List<Items> getBabyNeedsData(){
        String []data = {"Infant Bodysuit","Outfit","Jumpsuit","Baby Socks","Baby Hat","Baby Pyjamas",
        ...
        "Nasal Aspirator","Fly Repellent Lotion","Pyrometer","Antipyretic Syrup","Probiotic Powder",
        "Baby Backpack","Stroller","Baby carrier","Toys","Teether","Playpen","Baby Radio",
    ...
    public List<Items> getHealthData() {
        String []data = {"Aspirin","Drugs Used","Vitamins Used","Lens Solutions","Hot Water Bag",
    ...
    public List<Items> getTechnologyData() {
        ...
        "Portable Speaker","IPad (Tab)","Headphone","Laptop","Laptop Charger",
        "Mouse","Extension Cable","Data Transfer Cable","Battery","Power Bank","DVD Player",
    ...
    public List<Items> getFoodData() {
        String []data = {"Snack","Sandwich","Juice","Tea Bags","Coffee","Water","Thermos","Chips",
        "Baby Food"};
